...
import { Add, Button, File, Input, Loading, Modal, Target, Title } from "../../components/common";
...
const PrincipalPage = () => {
  ...
  const { loaderCategories, categories, createCategory, messageCategories, setCleanMessage } = useCategory();
  ...
  return (
    <Main title="Principal" description="Pagina Principal de Inventory">
      ...
      <section className={styles.containerTarget}>
        ...
        <Target count={categories.length} text="Total de Categorias" color="purpleLigth" />
      </section>
      ...
      <section className={styles.containerCard}>
        {loaderCategories ? (
          ...
          categories.map((categoria) => {
            return <Categoria key={categoria.id} categoria={categoria} onClick={() => handleRedirectProducts(categoria)} />;
          })
        )}
      </section>
